...
const ESTADO_CIVIL_PADRE = [
  { value: 1, label: '1. Soltero' }, { value: 2, label: '2. Casado' },
  { value: 3, label: '3. Unido' }, { value: 4, label: '4. Viudo' },
  { value: 5, label: '5. Divorciado' }, { value: 6, label: '6. Unión no declarada' },
]
